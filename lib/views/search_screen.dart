...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _searchProducts({bool resetPage = true}) async {
    ...
    try {
      final queryParameters = _filterController.buildQueryParameters(
        searchQuery: _searchController.text,
        page: _currentPage,
      );

      debugPrint('GET /api/products query: $queryParameters');
      ...
      setState(() {
        _errorMessage = 'Unable to search products. Please try again.';
      });
    } finally {
      if (mounted) {
        setState(() {
            ...
            children: [
              ...
              ..._availableCategories.map((category) {
                return ListTile(
                  ...
                  trailing: _filterController.selectedCategoryId == category.id
    ...
    final result = await showModalBottomSheet<_PriceFilterResult>(
      ...
      builder: (context) {
        return _PriceFilterSheet(
          initialMinimum: _filterController.minimumPrice,
          initialMaximum: _filterController.maximumPrice,
        );
      },
    );
  ...
  void dispose() {
    ...
    if (Get.isRegistered<FilterController>(tag: 'product-search-filter')) {
      Get.delete<FilterController>(tag: 'product-search-filter');
    }
                                            ...
                                            title:
                                                controller.minimumPrice !=
                                                    ...
                                                    controller.maximumPrice !=
                                                        null
                                                ? _priceFilterLabel(controller)
                                                : 'Price',
                                            isActive:
                                                controller.minimumPrice !=
                                                    null ||
                                                controller.maximumPrice != null,
                              ...
                              GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return ProductCard(
                                    ...
                                    newPrice: _formatPrice(product.price),
  ...
  String _priceFilterLabel(FilterController controller) {
...
class _PriceFilterSheet extends StatefulWidget {
  ...
  const _PriceFilterSheet({this.initialMinimum, this.initialMaximum});
...
class _PriceFilterSheetState extends State<_PriceFilterSheet> {
  ...
  void _apply() {
    ...
    Navigator.pop(
      context,
      _PriceFilterResult(minimum: minimum, maximum: maximum),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          TextButton(
            onPressed: () {
              Navigator.pop(context, const _PriceFilterResult());
            },
...
class _PriceFilterResult {
  ...
  const _PriceFilterResult({this.minimum, this.maximum});
}
